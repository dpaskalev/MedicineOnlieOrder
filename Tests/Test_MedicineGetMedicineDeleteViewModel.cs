...
{
    [TestFixture]
    public class Test_MedicineGetMedicineDeleteViewModel
    {
        ...
        public void Setup()
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(databaseName: "TestDB_Medicine_GetAddModel_5")
                .Options;
        ...
        [Test]
        public void GetMedicineDeleteViewModel()
        {
            IMedicineService MedicineService = new MedicineService(this.context);

            int Id = 2;
            MedicineDeleteViewModel result = MedicineService.GetMedicineDeleteViewModel(Id, "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd").Result;
