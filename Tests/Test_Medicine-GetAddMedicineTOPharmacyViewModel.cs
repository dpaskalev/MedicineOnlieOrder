...
{
    [TestFixture]
    public class Test_Medicine_GetAddMedicineTOPharmacyViewModel
    {
        ...
        public void Setup()
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(databaseName: "TestDB_Medicine_GetAddModel_1")
                .Options;
        ...
        public void Test_GetIndexMethod()
        {
            ...
            var result = MedicineService.GetAddMedcineToPharmacyViewModelAsync(Id, "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd");

            Assert.True(result.Result != null);
            Assert.True(result.Result.Name == "TestMed_2");
