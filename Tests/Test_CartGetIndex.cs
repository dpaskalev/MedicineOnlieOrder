...
{
    [TestFixture]
    public class Test_CartGetIndex
    {
        ...
        public void Setup()
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(databaseName: "TestDB_Cart_2")
                .Options;
        ...
        public void Test_GetIndex()
        {
            ...
            string UserId = "df1c3a0f-1234-4cde-bb55-d5f15a6aabcd";

            var result = service.GetIndexAsync(UserId).Result;
